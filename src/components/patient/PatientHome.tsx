...
import type { PatientReminder, GameResult, PatientProfile, PairingRequest } from '../../types';
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 pb-24 font-sans relative">
      ...
      {pairingRequests.length > 0 && (
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 max-w-md w-11/12 bg-slate-900 text-white p-4 rounded-3xl shadow-2xl border border-sky-400/50 flex flex-col gap-3 animate-in slide-in-from-top duration-300">
